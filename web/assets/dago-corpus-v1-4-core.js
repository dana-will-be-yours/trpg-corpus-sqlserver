(()=>{'use strict';
const VERSION='trpg corpus input v1.4';
...
function ensureCoreVersion(expected=VERSION){if(expected!==VERSION)throw new Error(`trpg corpus input v1.4 core version mismatch: expected ${expected}, actual ${VERSION}`);return VERSION}
window.DagoCorpusV14Core={VERSION,SPEAKER_TYPES,UTTERANCE_FUNCTIONS,UTT_FIELDS,MAP_FIELDS,BATCH_FIELDS,nowIso,padNo,cleanValue,escapeHtml,xmlEscape,csvEscape,targetTableForSpeakerType,legacyTargetTableForSpeakerType,safeSpeakerCode,isSpeakerType,isUtteranceFunction,normalizeUtteranceCode,downloadBlob,makeTimestampedFilename,utf16leBlob,objectFromFields,ensureCoreVersion};
})();
