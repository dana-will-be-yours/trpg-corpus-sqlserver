...
WHERE scenario_code = N'xiaocheng_jiushi';
GO
...
USING (VALUES
    (
        ...
        N'常山縣一年',
        N'大興十年天津郡常山縣',
        N'大興十年，玩家抵達天津郡常山縣。縣城、客棧、市集、縣衙、河埠與田里提供短工、問訊、休息、修習與人物往來。',
        N'大興十年正月八日起；玩家活動以天津郡常山縣為主。',
        N'天津郡 常山縣',
        N'["東門、客棧、市集、縣衙與河埠短工","疲勞、飢餓、精神與鎮定管理","NPC 日常往來與長期事件","4D3+調整值+技能值檢定","可回寫 TRPG Corpus playlog JSON"]',
        N'{"title":"大國年代記","political_context":"大興十年，天津郡常山縣位在水陸轉運與鄉里糧務交會處，縣衙、商旅、工坊與河埠各有消息來源。","hidden_goal":"在此地找到工作生活一年","themes":["立足","活計","人情","地方秩序","長期生活"]}',
...
USING (VALUES
    (N'changshan_year', N'Gate', N'常山縣東門', N'東門', N'city_gate', 1, N'開局地點，連接活計牌、客棧、河埠與縣衙。', 10),
    (N'changshan_year', N'WorkBoard', N'活計牌', N'東門', N'job_board', 1, N'短工、跑腿、搬運與抄錄工作來源。', 20),
    (N'changshan_year', N'Inn', N'客棧', N'縣城', N'lodging', 1, N'短租、旅人消息與梁三、姚娘人物線。', 30),
    (N'changshan_year', N'Market', N'市集', N'縣城', N'market', 1, N'貨郎、醫鋪、工坊與日用交易。', 40),
    (N'changshan_year', N'Granary', N'糧倉', N'官倉', N'workplace', 1, N'搬糧、盤帳、糧價與縣中秩序。', 50),
    (N'changshan_year', N'Workshop', N'工坊', N'縣城', N'workplace', 1, N'修車、辨材與工匠關係。', 60),
    (N'changshan_year', N'Yamen', N'縣衙', N'官署', N'government', 1, N'舊案、戶籍與唐簡、沈簿人物線。', 70),
    (N'changshan_year', N'Dock', N'南河埠', N'河埠', N'harbour', 1, N'水路、搬運與夜運消息。', 80),
    (N'changshan_year', N'RiverPath', N'河岸小路', N'河埠', N'path', 1, N'跟蹤、觀察與繞行情節。', 90),
    (N'changshan_year', N'Field', N'田埂', N'田里', N'field', 1, N'田工、水渠、糧務與趙禾人物線。', 100),
    (N'changshan_year', N'Clinic', N'醫鋪', N'縣城', N'clinic', 1, N'小傷病、藥材與林菱人物線。', 110),
    (N'changshan_year', N'Shrine', N'城隍廟', N'縣城', N'shrine', 1, N'阿芫、傳聞與隱蔽問訊。', 120),
    (N'changshan_year', N'Lodging', N'借住小院', N'住處', N'save_point', 1, N'休息、存檔點與修習入口。', 130)
...
USING (VALUES
    (N'changshan_year', N'npc_liang_san', N'梁三', N'客棧跑堂，熟悉旅人去向。', N'Inn', N'["客棧","旅人"]', N'旅人消息入口。', 10),
    (N'changshan_year', N'npc_yao_niang', N'姚娘', N'客棧掌櫃，掌握短租與欠帳消息。', N'Inn', N'["客棧","短租"]', N'借住與錢債線。', 20),
    (N'changshan_year', N'npc_chen_si', N'貨郎陳四', N'市集貨郎，知道各家近況。', N'Market', N'["市集","貨物"]', N'日用品、流言與價格線。', 30),
    (N'changshan_year', N'npc_zhao_he', N'趙禾', N'田里雇主，常招短工。', N'Field', N'["田里","活計"]', N'長期工作線。', 40),
    (N'changshan_year', N'npc_lao_zhou', N'老周', N'糧倉管事，掌握糧務與搬運。', N'Granary', N'["糧倉","糧務"]', N'糧務與工錢線。', 50),
    (N'changshan_year', N'npc_lao_pei', N'老裴', N'河埠船工，熟悉水路與夜運。', N'Dock', N'["河埠","水路"]', N'水路與夜運線。', 60),
    (N'changshan_year', N'npc_tang_jian', N'唐簡', N'縣衙書吏，熟悉案卷。', N'Yamen', N'["縣衙","案卷"]', N'舊案與戶籍入口。', 70),
    (N'changshan_year', N'npc_lin_ling', N'林菱', N'醫鋪學徒，能處理小傷小病。', N'Clinic', N'["醫鋪","藥材"]', N'醫療與藥材線。', 80),
    (N'changshan_year', N'npc_a_yuan', N'阿芫', N'城隍廟賣香人，記人很準。', N'Shrine', N'["城隍廟","傳聞"]', N'人際與隱蔽消息線。', 90),
    (N'changshan_year', N'npc_shen_bu', N'沈簿', N'縣衙簿書，偶爾查核戶籍。', N'Yamen', N'["縣衙","戶籍"]', N'身份查核與壓力事件。', 100)
...
USING (VALUES
    (N'changshan_year', N'quest_work_life', N'常山立足', N'研究者隱藏目標：玩家在此地找到工作生活一年。玩家端不直接顯示。', N'["接觸活計牌","取得可重複短工","找到穩定住處","維持一年生活"]', 10),
    (N'changshan_year', N'quest_npc_relations', N'地方人物', N'研究者用：透過短工、問訊、交易與休息累積 NPC 關係。', N'["認識客棧人物","接觸市集人物","接觸縣衙人物","接觸河埠與田里人物"]', 20),
    (N'changshan_year', N'quest_county_records', N'縣中舊案', N'研究者用：縣衙、河埠、糧倉與市集消息形成一年分支。', N'["取得戶籍線索","取得夜運線索","取得糧務線索","依玩家狀態開啟事件"]', 30)
...
SELECT
    N'changshan_year' AS scenario_code,
    N'1.11.0-changshan-year' AS da_go_version,
    (SELECT COUNT(*) FROM dbo.DaGo_Authoring_Scenario_Location WHERE scenario_code = N'changshan_year') AS location_count,
    (SELECT COUNT(*) FROM dbo.DaGo_Authoring_Scenario_NPC WHERE scenario_code = N'changshan_year') AS npc_count,
    (SELECT COUNT(*) FROM dbo.DaGo_Authoring_Scenario_Quest WHERE scenario_code = N'changshan_year') AS quest_count;
GO
