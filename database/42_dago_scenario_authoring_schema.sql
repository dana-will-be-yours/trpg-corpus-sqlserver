...
USING (VALUES
    (
        ...
        N'{"title":"大國年代記","abbreviation":"DAGO","era_abbreviation":"DC","political_context":"大興十年，天津郡常山縣位在水陸轉運與鄉里糧務交會處，縣衙、商旅、工坊與河埠各有消息來源。天津郡下含常山縣、衡水縣、珩灣縣，滄北邑隸屬珩灣縣。","themes":["立足","活計","人情","地方秩序","長期生活"]}',
